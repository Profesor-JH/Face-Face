...
def truncate_context(query: str, context: str) -> str:
    ...
    prompt = f"""
    You are assisting investors in analyzing market sentiments and detecting relevant topics. Provide detailed, relevant, and professionally formatted responses based on the user's query and the given context. Ensure the response is clear, visually appealing, and easy to read by using bullet points and line breaks to separate sections.    User query: {query}
